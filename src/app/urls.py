...
urlpatterns = [
    ...
    path("toggle_grouping", views.toggle_grouping, name="toggle_grouping"),
    path("toggle_pin", views.toggle_pin, name="toggle_pin"),
    path("save_pin_order", views.save_pin_order, name="save_pin_order"),
