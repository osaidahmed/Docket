...
class StatisticsDateFilteringTests(TestCase):
    ...
    def _create_movie_fixtures(self):
        specs = [
            (
                "238",
                "Movie with start and end dates",
                Status.COMPLETED.value,
                {
                    "score": 7.5,
                    "start_date": _dt(2025, 2, 10),
                    "end_date": _dt(2025, 2, 10),
                },
            ),
            (
                "239",
                "Movie with only start date",
                Status.IN_PROGRESS.value,
                {"score": 8.0, "start_date": _dt(2025, 2, 15)},
            ),
            (
                "240",
                "Movie with only end date",
                Status.COMPLETED.value,
            ...
            (
                "242",
                "Movie outside date range (before)",
                Status.COMPLETED.value,
                {
                    "score": 9.0,
                    "start_date": _dt(2025, 1, 10),
                    "end_date": _dt(2025, 1, 15),
                },
            ),
            (
                "243",
                "Movie outside date range (after)",
                Status.PLANNING.value,
                {"start_date": _dt(2025, 3, 10), "end_date": _dt(2025, 3, 15)},
            ),
            (
                "244",
                "Movie partially in range (starts before, ends in range)",
                Status.COMPLETED.value,
                {
                    "score": 7.0,
                    "start_date": _dt(2025, 1, 25),
                    "end_date": _dt(2025, 2, 5),
                },
            ),
            (
                "245",
                "Movie partially in range (starts in range, ends after)",
                Status.COMPLETED.value,
                {
                    "score": 8.5,
                    "start_date": _dt(2025, 2, 25),
                    "end_date": _dt(2025, 3, 5),
                },
            ),
        ]
    ...
    def test_overlapping_ranges(self):
        ...
        spanning_item = _create_item(
            ...
            "Movie that spans the entire range",
        )
        _create_movie(
            self.user,
            spanning_item,
            Status.COMPLETED.value,
            start_date=_dt(2025, 1, 15),
            end_date=_dt(2025, 3, 15),
        )
