...
def tv_sort(queryset, sort_filter, sort_dir):
    return _sort_related(
        queryset,
        sort_filter,
        sort_dir,
        _TV_SORT_FIELDS,
...
def season_sort(queryset, sort_filter, sort_dir):
    return _sort_related(queryset, sort_filter, sort_dir, _SEASON_SORT_FIELDS)


def generic_sort(queryset, sort_filter, sort_dir):
    return _sort_generic(queryset, sort_filter, sort_dir)


def _sort_related(queryset, sort_filter, sort_dir, sort_fields, ep_filter=None):
...
def _sort_generic(queryset, sort_filter, sort_dir="desc"):
